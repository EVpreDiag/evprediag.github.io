...
const PrintSummary = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 print:bg-white print:text-black">
      ...
      {/*
        Add print and PDF-specific styles. Tailwind's `print:` modifiers are not
        applied by html2pdf when exporting the document, so we replicate the
        important print styles here and also define a `.pdf-mode` class that
        applies these styles when generating the PDF.  This ensures the
        downloaded PDF closely matches the printed version, with two-column
        layout, consistent spacing, borders, and light backgrounds.
      */}
      <style>{`
        @media print {
          ...
          /* Remove dark backgrounds when printing */
          * {
            background-color: transparent !important;
            -webkit-print-color-adjust: exact !important;
            color-adjust: exact !important;
          }
          /* Ensure the print section has a white background */
          #print-section {
        ...
        /* Styles for PDF mode (html2pdf).  These mimic the print styles above */
        .pdf-mode {
        ...
        /* Lighten dark backgrounds in PDF */
